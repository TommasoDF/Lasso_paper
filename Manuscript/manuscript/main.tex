...
\input{sections/03_the_model}
\input{sections/04_recursive_least_squares_learning}
\input{sections/05_weighted_least_squares_constant_gain_learning}
\input{sections/06_lasso_regression}
\input{sections/06b_garch_extension}
\input{sections/06c_correlated_predictor_extension}
\input{sections/07_empirical_application}
\input{sections/08_conclusion}
\newpage
\bibliography{references}
\newpage
\appendix
\input{sections/A1_derivation_recursive_learning_models}
\input{sections/A2_proofs}
\input{sections/A3_additional_tables_figures}
\input{sections/A4_oracle_test_estimation_model_generated_data}
\input{sections/A5_robustness}
\end{document}
